	...
	<div class="bg-white">
		<div id="base">
			<div id="container">
				<dl id="contents"> 
					<div class="info_area">
						<label for="dispname" class="info_title">表示名</label>
						<input type="text" id="u_dispname" name="dispname" class="info_input" value="<?php print $_SESSION['DISPNAME']; ?>" />
					</div>
					<div class="info_area">
						<label for="email" class="info_title">mail</label>
						<input type="email" id="u_email" name="email" class="info_input" value="<?php print $_SESSION['EMAIL']; ?>" />
					</div>
					<div class="info_area">
